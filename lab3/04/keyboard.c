...
char practice_1[BUFSIZE] = "Hello. input my text";
char practice_2[BUFSIZE] = "my name is Park Yoon A";
char practice_3[BUFSIZE] = "20203156";
...
int main(){
    ...
    //초기화
    printf("20203156 박윤아 타자 연습 프로그램.\n");
